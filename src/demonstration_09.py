...
# To find out if the string length is even, we could decompose the logic into it's own function
...
def is_even(num):
    ...
    then return a boolean value of True if even and False if odd
